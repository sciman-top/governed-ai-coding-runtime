...
- `Near-Term Gap Horizon Queue / GAP-080` through `GAP-083` are complete on the current branch baseline (verified on 2026-04-21), and `GAP-084` remains the active execution-horizon queue (derived from `NT-01..05` and `NTP-01..05`).
...
4. Keep `GAP-084` as the active near-term execution queue unless verified regressions require reopening older ranges.
