...
- `Near-Term Gap Horizon Queue / GAP-080` through `GAP-084` is planned as the active execution-horizon queue (derived from `NT-01..05` and `NTP-01..05`, updated on 2026-04-21).
...
4. Keep `GAP-080` through `GAP-084` as the active near-term execution queue unless verified regressions require reopening older ranges.
