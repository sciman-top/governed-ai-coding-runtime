...
- `Near-Term Gap Horizon Queue / GAP-080` through `GAP-082` are complete on the current branch baseline (verified on 2026-04-21), and `GAP-083` through `GAP-084` remain the active execution-horizon queue derived from `NT-01..05` / `NTP-01..05`.
