...
## Context
`repo-governance-hub` is a governance mother-repo with source mirroring, distribution, backflow, and shared templates across multiple repositories. `governed-ai-coding-runtime` has a different primary goal: provide a governed runtime for AI coding.
