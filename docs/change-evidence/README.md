...
- [20260715 Agent Rule Governance 9.57](./20260715-agent-rule-governance-9.57.md)
  - current evidence ledger for the official five-hop Claude import correction, protected global sync, nine-target review-marker rollout, default-branch proof, and hosted/manual boundary
- [20260715 Agent Rule Governance 9.56 Current-State Reverification](./20260715-agent-rule-governance-9.56-current-state-reverification.md)
  - historical pre-9.57 current-state companion retained for the earlier six-effective/three-task-branch boundary; the 9.57 ledger above supersedes its live status claims
...
- [20260623 Self-Evolution Review Refresh](./20260623-self-evolution-review-refresh.md)
  - evidence companion for retaining the 2026-06-23 self-evolution, promotion, recommendation, core-principle, and certification artifacts as bounded review-only outputs
...
- [20260617 Self-Evolution Variant Review And Defer](./20260617-self-evolution-variant-review-and-defer.md)
  - evidence companion for ranking the current six `review_candidate` self-evolution variants, preserving the defer boundary, and keeping every effective-change lane review-only
- [20260617 Self-Evolution Review Refresh](./20260617-self-evolution-review-refresh.md)
  - evidence companion for the latest review-only self-evolution refresh, keeping generated readiness, variant, core-principle proposal, recommendation, promotion, and certification artifacts fresh without enabling unattended effective change
- [20260617 Active Queue Evidence-Upkeep Refresh](./20260617-active-queue-evidence-upkeep-refresh.md)
  - evidence companion for rerunning the bounded active loop, refreshing 7 target-run daily artifacts plus KPI/effect reports, and restoring the selector/planning truth to fresh `defer_ltp_and_refresh_evidence` without promoting a new implementation queue
- [20260616 Self-Evolution Review Refresh](./20260616-self-evolution-review-refresh.md)
  - evidence companion for the latest review-only self-evolution/core-principle refresh, keeping generated variants, promotion plans, proposals, and certification refresh as bounded evidence without enabling unattended effective change
- [20260616 Continuous Execution Runtime Gate Refresh](./20260616-continuous-execution-runtime-gate-refresh.md)
  - evidence companion for today's bounded active-loop refresh, fixing restricted-environment Runtime gate failures in repo-local test fixtures and publishing a fresh full Runtime pass while the selector still remains `defer_ltp_and_refresh_evidence`
- [20260615 Self-Evolution Review Refresh](./20260615-self-evolution-review-refresh.md)
  - evidence companion for the latest review-only self-evolution/core-principle refresh, keeping generated variants, promotion plans, and proposal patches as bounded evidence without enabling unattended effective change
...
- [20260614 Continuous Execution Promotion](./20260614-continuous-execution-promotion.md)
  - evidence companion for owner-directed promotion of the continuous-execution follow-on plan into the current active queue reference while keeping the selector unchanged and preserving the existing capability-first positioning/strategy boundary
- [20260614 Continuous Execution Readiness Reassessment](./20260614-continuous-execution-readiness-reassessment.md)
  - evidence companion for re-checking the continuous-execution activation trigger and recording that readiness is satisfied by existing repo-side evidence but still not promoted into the active queue
