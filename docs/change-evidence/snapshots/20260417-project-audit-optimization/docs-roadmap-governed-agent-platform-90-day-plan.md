...
### Week 1
**Goal**
- 初始化 monorepo 和统一开发骨架

**Tasks**
- 创建 `apps/`、`packages/`、`infra/`、`schemas/`、`tests/`、`docs/`
- 初始化 Python workspace、前端 workspace、统一 lint/test 命令
...
### First 8 tasks
1. Initialize monorepo structure and shared tooling
