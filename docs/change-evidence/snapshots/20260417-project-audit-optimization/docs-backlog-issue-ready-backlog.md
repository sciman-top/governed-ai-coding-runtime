...
- What to build:
  ...
  - establish docs, schemas, apps, packages, infra, tests layout
- Acceptance criteria:
  - [ ] project skeleton exists and is documented
  - [ ] local bootstrap command is defined
  - [ ] docs index links to active documents
...
- What to build:
  - turn task, repo profile, tool contract, risk, evidence, gates into a contracts package
