# Governed Agent Platform Docs Index
...
- [repo-governance-hub Borrowing Review](./research/repo-governance-hub-borrowing-review.md)
...
3. Minimum Viable Governance Loop
4. Governance Boundary Matrix
5. 90-Day Plan
6. Issue-Ready Backlog
7. ADRs
8. Specs
9. Schemas
10. Project Audit And Optimization
