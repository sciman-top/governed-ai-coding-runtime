...
- waiver and exception record
- provenance and attestation record
- repo-map and context-shaping contract
- sample repo profiles and sample control packs
...
- complete the missing contract families
...
### Week 1
**Goal**
- lock the governance-kernel boundary and missing contract families

**Tasks**
- add `ADR-0005`
- define `hook`, `skill manifest`, `knowledge source`, `waiver`, `provenance`, and `repo-map` contract placeholders or specs
- align roadmap and backlog around kernel-first execution

**Acceptance**
- kernel boundary is explicit and accepted
- missing contract families are named and prioritized
...
**Tasks**
- add at least two sample repo profiles
...
### First 8 tasks
1. Define hook, skill manifest, knowledge source, waiver, provenance, and repo-map contracts
...
## Release Criteria
- kernel contracts and sample control packs validate
