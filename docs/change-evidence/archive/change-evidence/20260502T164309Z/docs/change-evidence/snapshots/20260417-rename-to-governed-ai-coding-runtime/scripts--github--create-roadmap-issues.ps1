...
## Scope
- Use existing docs / schemas / scripts as the planning baseline
- Initialize missing apps / packages / infra / tests skeleton
- Keep root README and project AGENTS synchronized as repo entry contracts
...
## Acceptance Criteria
- [ ] Root README and project AGENTS stay aligned with the active docs baseline
- [ ] Missing implementation skeleton exists
- [ ] CI runs baseline checks
- [ ] Local bootstrap / verification entrypoints are documented
...
- [ ] Root README and project AGENTS stay aligned with the active docs index
- [ ] Python and frontend workspaces run locally
- [ ] Shared lint / test commands are available
- [ ] Shared schema commands are available
- [ ] Root README points to the active docs index
"@
    }
    @{
