...
class TargetRepoGovernanceConsistencyTests(unittest.TestCase):
    def test_default_baseline_requires_windows_process_environment_policy(self) -> None:
        ...
        self.assertIn("AGENTS.md community format guidance", " ".join(coordination["source_review_basis"]))
        self.assertIn("@AGENTS.md imports", " ".join(coordination["source_review_basis"]))
        ...
        self.assertIn("Trusted Folders safe mode", " ".join(coordination["source_review_basis"]))
        ...
        self.assertIn("AGENTS.md as the common project-rule body", " ".join(coordination["root_file_quality_rules"]))
        ...
        self.assertIn("@AGENTS.md", coordination["tool_specific_loading_policy"]["claude"])
        ...
        self.assertIn("common_project_rule_import_or_full_body", coordination["required_project_rule_fields"])
        ...
        self.assertIn(".githooks/commit-msg", [item["path"] for item in managed_files])
        self.assertIn("scripts/hooks/commit-msg.ps1", [item["path"] for item in managed_files])
        ...
        self.assertEqual(managed_file_modes[".githooks/commit-msg"], "block_on_drift")
        self.assertEqual(managed_file_modes["scripts/hooks/commit-msg.ps1"], "block_on_drift")
