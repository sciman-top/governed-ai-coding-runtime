...
class TargetRepoGovernanceConsistencyTests(unittest.TestCase):
    def test_default_baseline_requires_windows_process_environment_policy(self) -> None:
        ...
        self.assertIn("settings/permissions", coordination["tool_specific_loading_policy"]["claude"])
        self.assertIn("/memory list/show", coordination["tool_specific_loading_policy"]["gemini"])
