...
class OperatorUiTests(unittest.TestCase):
    ...
    def test_operator_ui_interactive_mode_renders_actions_and_ref_buttons(self) -> None:
        ...
        self.assertIn("data-action='codex_interop_check'", html)
        self.assertIn("data-action='codex_projection_smoke'", html)
        self.assertIn("data-action='codex_api_projection_repair'", html)
        self.assertIn("data-action='codex_oauth_projection_repair'", html)
        self.assertIn("data-action='codex_launch_binding_repair'", html)
        self.assertIn("data-action='codex_switch_record'", html)
        ...
        self.assertIn("检查 provider 互操作", html)
        self.assertIn("投影 smoke", html)
        self.assertIn("修复 API 投影", html)
        self.assertIn("修复 OAuth 投影", html)
        self.assertIn("修复启动跟随", html)
        self.assertIn("不会重启 Codex", html)
        self.assertIn("Cockpit 兼容排障", html)
        self.assertIn("id='codex-switch-health'", html)
        self.assertIn("切号连续性状态待刷新", html)
        self.assertIn("App 需重启落地", html)
        self.assertIn("CLI 分段连续", html)
        self.assertNotIn("修复 Cockpit 接管", html)
        self.assertNotIn("可能覆盖 8770 当前选择", html)
        self.assertIn("保存切换记录", html)
        self.assertIn("确认守护已移除", html)
        ...
        self.assertIn("id='codex-cache-state'", html)
        ...
        self.assertIn("function formatClaudeSessionContinuity(continuity)", html)
        ...
        self.assertIn("fetch('/api/codex/status', { cache: 'no-store' })", html)
        self.assertIn("默认本机刷新；要实时额度请强制在线刷新。", html)
        self.assertIn("额度快照已过期", html)
        ...
        self.assertIn("function isUsageSnapshotStale(snapshot)", html)
        self.assertIn("function shouldHydrateCodexCache(payload)", html)
        ...
        self.assertIn("refreshCodexStatus();", html)
        ...
        self.assertIn("function createUsageMeter(account)", html)
        self.assertIn("function formatRelativeAgeLabel(ageSeconds)", html)
        self.assertIn("function formatUsageFreshnessLabel(usage)", html)
        self.assertIn("className = 'usage-meter-list'", html)
        self.assertIn("className = 'usage-fill'", html)
        self.assertIn("function daysRemainingLabel(timestamp)", html)
        self.assertIn("formatCompactTimestampWithDays", html)
        ...
        self.assertIn("createMultilineInfoValue(formatSubscriptionExpirySummary(account))", html)
        ...
        self.assertIn("function formatCodexSnapshotStatus(snapshot)", html)
        self.assertIn("formatCodexSnapshotStatus(snapshot)", html)
        ...
        self.assertIn("fetch('/api/codex/probe'", html)
        self.assertIn("id='codex-history-form'", html)
        self.assertIn("id='codex-history-results'", html)
        self.assertIn("fetch('/api/codex/history?'", html)
        self.assertIn("完整历史查询", html)
        self.assertIn("只读查询 state_5.sqlite 元数据", html)
        self.assertIn("function refreshCodexHistory(resetOffset = false)", html)
        self.assertIn("data-codex-history-next", html)
        self.assertNotIn("importCockpitCodexAccounts", html)
        self.assertNotIn("importCodexPayload", html)
        self.assertIn("probeCodexProfiles", html)
        self.assertNotIn("不可切换", html)
        self.assertIn("CLI 当前", html)
        self.assertIn("App 持久化", html)
        self.assertIn("官方 App 持久化", html)
        ...
        self.assertIn("Claude Code / Claude Desktop 的账号、API 和 provider 切换只由 CC Switch 负责", html)
        ...
        self.assertIn("const isCliActive = !!account.active;", html)
        self.assertIn("const isOfficialAppCurrent = !!account.official_app_current;", html)
        self.assertIn("只开放本机 Claude 配置相关文件预览", html)
        self.assertIn("会话连续性", html)
        self.assertIn("formatClaudeSessionContinuity(payload.session_continuity || null)", html)
