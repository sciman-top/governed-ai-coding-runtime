...
class OperatorUiTests(unittest.TestCase):
    ...
    def test_operator_ui_interactive_mode_renders_actions_and_ref_buttons(self) -> None:
        ...
        self.assertIn("data-action='codex_interop_repair'", html)
        self.assertIn("data-action='codex_switch_record'", html)
        self.assertIn("data-action='codex_guard_status'", html)
        self.assertIn("data-action='codex_guard_start'", html)
        self.assertIn("应用共享历史优化", html)
        self.assertIn("检查共享历史互操作", html)
        self.assertIn("修复 Cockpit/Codex 互操作", html)
        self.assertIn("保存切换记录", html)
        self.assertIn("查看切换守护", html)
        self.assertIn("启动切换守护", html)
        ...
        self.assertNotIn("hydratePanelCache('codex', codexCacheKey);\n      refreshCodexStatus();", html)
        ...
        self.assertIn("导入 Cockpit 账号", html)
        self.assertIn("探测已保存账号", html)
