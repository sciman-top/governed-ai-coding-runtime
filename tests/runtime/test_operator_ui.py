...
class OperatorUiTests(unittest.TestCase):
    ...
    def test_operator_ui_interactive_mode_renders_actions_and_ref_buttons(self) -> None:
        ...
        self.assertIn("function renderClaudeSummary(payload)", html)
        ...
        self.assertIn("function formatCodexAuthPointer(auth)", html)
        ...
        self.assertIn("套餐日期来自本地 token 声明", html)
        ...
        self.assertIn("id='claude-summary'", html)
        self.assertIn("className = account.active ? 'codex-account-switch is-current' : 'codex-account-switch'", html)
        self.assertIn("套餐到期日", html)
        self.assertIn("登录令牌到期", html)
        self.assertIn("登录令牌到期只表示本地 Codex 登录凭据", html)
        self.assertIn("id='codex-cache-state'", html)
        self.assertIn("id='claude-cache-state'", html)
        ...
        self.assertIn("本机 auth.json ->", html)
