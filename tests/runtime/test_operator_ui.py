...
class OperatorUiTests(unittest.TestCase):
    ...
    def test_operator_ui_interactive_mode_renders_actions_and_ref_buttons(self) -> None:
        ...
        self.assertIn("应用 provider 优先优化", html)
        ...
        self.assertIn("data-codex-sync-name", html)
        self.assertIn("data-codex-save-active", html)
        self.assertIn("data-codex-delete-name", html)
        self.assertIn("function formatCodexSnapshotStatus(snapshot)", html)
        self.assertIn("formatCodexSnapshotStatus(snapshot)", html)
        self.assertIn("fetch('/api/codex/sync-active'", html)
        self.assertIn("fetch('/api/codex/save-active'", html)
        self.assertIn("fetch('/api/codex/delete'", html)
        self.assertIn("同步快照", html)
        self.assertIn("保存当前快照", html)
        self.assertIn("将先备份再删除这个本地 Codex 账号快照", html)
        self.assertIn("保存 API", html)
        self.assertIn("id='codex-api-form'", html)
        self.assertIn("id='codex-api-base-url'", html)
        self.assertIn("id='codex-api-key'", html)
        self.assertIn("fetch('/api/codex/save-api'", html)
        self.assertIn("saveCodexApiAccount", html)
        self.assertIn("同步 Cockpit", html)
        self.assertIn("探测账号", html)
        self.assertIn("id='codex-import-form'", html)
        self.assertIn("id='codex-import-format'", html)
        self.assertIn("id='codex-import-content'", html)
        self.assertIn("fetch('/api/codex/import-cockpit'", html)
        self.assertIn("fetch('/api/codex/import-payload'", html)
        ...
        self.assertIn("importCockpitCodexAccounts", html)
        self.assertIn("importCodexPayload", html)
        self.assertIn("probeCodexProfiles", html)
        self.assertIn("缺少 Base URL", html)
        self.assertIn("不可切换", html)
