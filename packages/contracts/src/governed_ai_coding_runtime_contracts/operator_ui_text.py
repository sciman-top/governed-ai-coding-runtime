...
TRANSLATIONS = {
    "zh-CN": {
        ...
        "codex_legacy_tools_hint": "仅用于 Cockpit 事故只读取证；修复和启动守护动作已废弃。",
        "codex_interop_check": "检查 provider 互操作",
        "codex_switch_record": "保存切换记录",
        "codex_guard_status": "查看已废弃守护状态",
        "codex_local_optimize": "应用 provider 优先优化",
        "codex_local_optimize_confirm": "将备份并写入本机 Codex provider 优先配置，安装共享启动器；不会迁移历史桶、安装守护或修改 Cockpit launch-on-switch。继续执行？",
    ...
    "en": {
        ...
        "codex_legacy_tools_hint": "Use only for read-only Cockpit incident evidence; repair and guard start actions are deprecated.",
        ...
        "codex_local_optimize": "Apply provider-first optimize",
        "codex_local_optimize_confirm": "This will back up and write local Codex provider-first config and install shared launchers. It will not migrate history buckets, install guards, or change Cockpit launch-on-switch. Continue?",
