...
TRANSLATIONS = {
    "zh-CN": {
        ...
        "codex_interop_check": "检查共享历史互操作",
        "codex_interop_repair": "修复 Cockpit/Codex 互操作",
        "codex_interop_repair_confirm": "将备份并修复 Codex/Cockpit 本机配置、auth 投影和历史 provider bucket，不会重启 Codex App。继续执行？",
        "codex_switch_record": "保存切换记录",
        "codex_guard_status": "查看切换守护",
        "codex_guard_start": "启动切换守护",
        "codex_local_optimize": "应用共享历史优化",
        "codex_local_optimize_confirm": "将备份并写入本机 Codex 共享历史配置，安装共享启动器。继续执行？",
    ...
    "en": {
        ...
        "codex_api_save": "Save API account",
        "codex_api_missing": "Enter account name, Base URL, and API key.",
        "codex_api_save_confirm": "This saves the API key as a local Codex auth profile and projects config into the shared openai history bucket. It will not restart Codex App. Continue?",
        "codex_import_cockpit": "Import Cockpit accounts",
        ...
        "codex_interop_check": "Check shared-history interop",
        "codex_interop_repair": "Repair Cockpit/Codex interop",
        "codex_interop_repair_confirm": "This will back up and repair local Codex/Cockpit config, auth projection, and history provider buckets. It will not restart Codex App. Continue?",
        "codex_switch_record": "Save switch record",
        "codex_guard_status": "Show switch guard",
        "codex_guard_start": "Start switch guard",
        "codex_local_optimize": "Apply shared history optimize",
        "codex_local_optimize_confirm": "This will back up and write the local Codex shared-history config and install shared launchers. Continue?",
