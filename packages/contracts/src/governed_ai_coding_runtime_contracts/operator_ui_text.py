...
TRANSLATIONS = {
    "zh-CN": {
        ...
        "codex_account": "账号",
        "codex_active": "当前",
        "codex_cli_active": "CLI 当前",
        "codex_app_persisted": "App 持久化",
        "codex_cli_and_app": "CLI / App",
        "codex_app_ambiguous": "官方 App 当前账号仍有歧义",
        "codex_usage": "额度",
        ...
        "codex_save_active": "保存当前快照",
        "codex_save_active_prompt": "输入新的本地 Codex 快照名（不要带 .json）",
        "codex_save_active_confirm": "将把当前 auth.json 保存为新的命名快照，不会切换当前登录。继续执行？",
        "codex_snapshot": "快照",
        "codex_snapshot_synced": "已与 {name} 同步",
        "codex_snapshot_drifted": "{name} 是旧快照，建议回写",
        "codex_snapshot_missing": "当前活动账号还没有命名快照",
        "codex_sync_confirm": "将把当前 auth.json 覆盖回对应命名快照。继续执行？",
        "codex_sync_ok": "已同步当前账号快照。",
        "codex_api_profile": "API 账号",
        "codex_api_name": "账号名",
        "codex_api_base_url": "Base URL",
        "codex_api_key": "API Key",
        "codex_api_probe": "保存前探测 /models",
        "codex_api_switch_now": "保存后立即切换",
        "codex_api_save": "保存 API",
        "codex_api_missing": "请填写账号名、Base URL 和 API Key。",
        "codex_api_save_confirm": "将保存 API Key 到本机 Codex auth profile，并按 API provider 优先投影 custom provider 配置。不会重启 Codex App。继续执行？",
        "codex_import_cockpit": "同步 Cockpit",
        "codex_import_cockpit_confirm": "将只读导入 Cockpit Tools 当前 Codex OAuth/API 账号到本机 Codex auth profile，并做在线探测。不会启动 Codex App。继续执行？",
        "codex_probe_all": "探测账号",
        "codex_import_payload": "导入账号",
        "codex_import_format": "格式",
        "codex_import_probe": "导入时探测",
        "codex_import_dry_run": "仅预览",
        "codex_import_json": "内容",
        "codex_import_placeholder": "粘贴 Cockpit Tools / cpa / sub2api JSON，或每行一个 refresh token",
        "codex_import_save": "导入",
        "codex_import_confirm": "将导入这些凭据到本机 Codex auth profile。输出会脱敏，但文件会保存真实凭据。继续执行？",
        "codex_import_missing": "请粘贴要导入的 JSON 或 token 内容。",
        "codex_history_title": "完整历史查询",
        "codex_history_hint": "只读查询 state_5.sqlite 元数据；不扫描会话正文、不迁移 provider、不修复历史。",
        "codex_history_source": "来源",
        "codex_history_project": "项目路径",
        "codex_history_search": "搜索",
        "codex_history_search_placeholder": "标题、首条用户消息、路径或 thread id",
        "codex_history_limit": "每页",
        "codex_history_query": "查询历史",
        "codex_history_prev": "上一页",
        "codex_history_next": "下一页",
        "codex_history_idle": "等待查询；默认显示 vscode + cli 最近 50 条。",
        "codex_history_loading": "正在读取只读历史索引...",
        "codex_history_empty": "没有匹配的历史记录。",
        "codex_history_readonly": "只读",
        "codex_open_usage": "打开官方 Usage",
        "codex_legacy_tools": "Cockpit 兼容排障",
        "codex_legacy_tools_hint": "用于 Cockpit 事故取证和显式 API 投影修复；不会启动、停止或重启 Codex。",
        "codex_interop_check": "检查 provider 互操作",
        "codex_projection_smoke": "投影 smoke",
        "codex_api_projection_repair": "修复 API 投影",
        "codex_api_projection_repair_confirm": "将把当前 Cockpit API account 显式投影到 Codex CLI/App，写入 auth/config/custom no-WebSocket provider/history bucket/picker 可见性元数据，并创建备份；不会重启 Codex。继续执行？",
        "codex_oauth_projection_repair": "修复 OAuth 投影",
        "codex_oauth_projection_repair_confirm": "将把当前 Cockpit OAuth account 显式投影到 Codex CLI/App，写入 auth/config/openai history bucket/picker 可见性元数据，并创建备份；不会重启 Codex。继续执行？",
        "codex_launch_binding_repair": "修复启动跟随",
        "codex_launch_binding_repair_confirm": "将把 Cockpit Codex 默认启动设置修复为 followLocalAccount 并清除固定 bindAccountId，只写 codex_instances.json 备份；不会重启 Codex。继续执行？",
        "codex_switch_record": "保存切换记录",
        "codex_guard_absence_check": "确认守护已移除",
        ...
        "codex_refresh_if_stale": "默认本机刷新；要实时额度请强制在线刷新。",
        "codex_switch_health_loading": "切号连续性状态待刷新",
        "codex_switch_native_cli_segmented": "CLI 分段连续",
        "codex_switch_native_app_restart_required": "App 需重启落地",
        "codex_switch_selected_accounts": "选中账号",
        "codex_switch_selected_plans": "分组",
        "codex_switch_recent_401": "近期 401/token",
        "codex_switch_no_restart_action": "未提供自动重启动作",
        ...
        "codex_recommended_note": "长期目标是高效低打扰；当前组合仅作阶段实现。",
        "codex_login": "登录状态",
        ...
        "claude_managed_by_cc_switch": "Claude Code / Claude Desktop 的账号、API 和 provider 切换只由 CC Switch 负责；本面板只做只读状态与会话连续性检查。",
        "claude_provider": "Provider",
        "claude_active": "当前",
        "claude_switch": "由 CC Switch 切换",
        "claude_delete": "由 CC Switch 管理",
        ...
        "claude_session_continuity": "会话连续性",
        "claude_timeout": "超时",
        "claude_subagent": "子代理",
        "claude_note": "建议",
    ...
    "en": {
        ...
        "codex_active": "Active",
        "codex_cli_active": "CLI Active",
        "codex_app_persisted": "App Persisted",
        "codex_cli_and_app": "CLI / App",
        "codex_app_ambiguous": "Official App current account is still ambiguous",
        "codex_usage": "Usage",
        ...
        "codex_save_active": "Save current snapshot",
        "codex_save_active_prompt": "Enter a new local Codex snapshot name without .json",
        "codex_save_active_confirm": "Save the current auth.json as a new named snapshot without switching the active login?",
        "codex_snapshot": "Snapshot",
        "codex_snapshot_synced": "Synced with {name}",
        "codex_snapshot_drifted": "{name} is stale; save current login back",
        ...
        "codex_api_profile": "API account",
        "codex_api_name": "Account name",
        "codex_api_base_url": "Base URL",
        "codex_api_key": "API Key",
        "codex_api_probe": "Probe /models before saving",
        "codex_api_switch_now": "Switch after saving",
        "codex_api_save": "Save API",
        "codex_api_missing": "Enter account name, Base URL, and API key.",
        "codex_api_save_confirm": "This saves the API key as a local Codex auth profile and projects a custom API provider first. It will not restart Codex App. Continue?",
        "codex_import_cockpit": "Sync Cockpit",
        "codex_import_cockpit_confirm": "This read-only imports current Cockpit Tools Codex OAuth/API accounts into local Codex auth profiles and probes connectivity. It will not start Codex App. Continue?",
        "codex_probe_all": "Probe accounts",
        "codex_import_payload": "Import accounts",
        "codex_import_format": "Format",
        "codex_import_probe": "Probe during import",
        "codex_import_dry_run": "Preview only",
        "codex_import_json": "Content",
        "codex_import_placeholder": "Paste Cockpit Tools / cpa / sub2api JSON, or one refresh token per line",
        "codex_import_save": "Import",
        "codex_import_confirm": "This imports credentials into local Codex auth profiles. Output is redacted, but files will store real credentials. Continue?",
        "codex_import_missing": "Paste JSON or token content to import.",
        "codex_history_title": "Full history query",
        "codex_history_hint": "Read-only query over state_5.sqlite metadata; no transcript scan, provider migration, or history repair.",
        "codex_history_source": "Source",
        "codex_history_project": "Project path",
        "codex_history_search": "Search",
        "codex_history_search_placeholder": "Title, first user message, path, or thread id",
        "codex_history_limit": "Page size",
        "codex_history_query": "Query history",
        "codex_history_prev": "Previous",
        "codex_history_next": "Next",
        "codex_history_idle": "Waiting for query; default shows the latest 50 vscode + cli rows.",
        "codex_history_loading": "Reading read-only history index...",
        "codex_history_empty": "No matching history rows.",
        "codex_history_readonly": "read-only",
        "codex_open_usage": "Open Usage",
        "codex_legacy_tools": "Cockpit compatibility diagnostics",
        "codex_legacy_tools_hint": "Use for Cockpit incident evidence and explicit API projection repair; this will not start, stop, or restart Codex.",
        "codex_interop_check": "Check provider interop",
        "codex_projection_smoke": "Projection smoke",
        "codex_api_projection_repair": "Repair API projection",
        "codex_api_projection_repair_confirm": "This will explicitly project the current Cockpit API account into Codex CLI/App, writing auth/config/custom no-WebSocket provider/history bucket/picker visibility metadata and creating backups. Codex will not be restarted. Continue?",
        "codex_oauth_projection_repair": "Repair OAuth projection",
        "codex_oauth_projection_repair_confirm": "This will explicitly project the current Cockpit OAuth account into Codex CLI/App, writing auth/config/openai history bucket/picker visibility metadata and creating backups. Codex will not be restarted. Continue?",
        "codex_launch_binding_repair": "Repair launch follow",
        "codex_launch_binding_repair_confirm": "This will set Cockpit Codex defaults to followLocalAccount and clear fixed bindAccountId, writing only a codex_instances.json backup. Codex will not be restarted. Continue?",
        "codex_switch_record": "Save switch record",
        "codex_guard_absence_check": "Verify guard removal",
        ...
        "codex_refresh_if_stale": "Default is local refresh; force online for live usage.",
        "codex_switch_health_loading": "Switch continuity status is waiting for refresh",
        "codex_switch_native_cli_segmented": "CLI segmented continuity",
        "codex_switch_native_app_restart_required": "App restart required",
        "codex_switch_selected_accounts": "Selected accounts",
        "codex_switch_selected_plans": "Plans",
        "codex_switch_recent_401": "Recent 401/token",
        "codex_switch_no_restart_action": "No automatic restart action",
        ...
        "codex_recommended_note": "Long-term principle: efficient, low-friction execution; current combo is temporary.",
        ...
        "claude_managed_by_cc_switch": "Claude Code / Claude Desktop account, API, and provider switching is owned by CC Switch only. This panel is read-only status and session-continuity diagnostics.",
        "claude_provider": "Provider",
        "claude_active": "Active",
        "claude_switch": "Use CC Switch",
        "claude_delete": "Managed by CC Switch",
        ...
        "claude_session_continuity": "Session continuity",
